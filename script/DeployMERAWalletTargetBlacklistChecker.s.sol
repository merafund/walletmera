...
/// @notice Deploys `MERAWalletTargetBlacklistChecker`. Set `CHECKER_INITIAL_OWNER` or it defaults to the broadcaster.
contract DeployMERAWalletTargetBlacklistChecker is Script {
    function run() external returns (MERAWalletTargetBlacklistChecker checker) {
        ...
        checker = new MERAWalletTargetBlacklistChecker(owner);
        vm.stopBroadcast();
