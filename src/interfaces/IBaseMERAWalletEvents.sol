...
interface IBaseMERAWalletEvents {
    ...
    event TargetTimelockUpdated(address indexed target, uint256 previousDelay, uint256 newDelay, address indexed caller);
    event SelectorTimelockUpdated(bytes4 indexed selector, uint256 previousDelay, uint256 newDelay, address indexed caller);
    ...
    event PendingTransactionExecuted(bytes32 indexed operationId, address indexed executor);
    event PendingTransactionCancelled(bytes32 indexed operationId, address indexed cancelledBy);
    event ImmediateTransactionExecuted(bytes32 indexed operationId, address indexed executor);
